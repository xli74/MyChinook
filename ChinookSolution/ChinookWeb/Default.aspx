...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        ...
        <p>
           Future festures will include movies and other video types, and the ability to request media for other users to add to their custom playlists.
        </p>
    </div>
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                To be able to create your playlists you must register as a customer.
            </p>
        </div>
        <div class="col-md-4">
            <h1>Request Music</h1>
